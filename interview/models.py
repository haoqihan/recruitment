...
class Candidate(models.Model):
    ...
    email = models.EmailField(max_length=135, blank=True, verbose_name="邮箱地址")
    ...
    # 第一轮面试记录
    first_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="初试分数",
                                      help_text="1-5分,极优秀:>=4.5,优秀:4-4.4,良好:3.5-3.93.5-3.9,一般: 3-3.4,较差: <3分")
    ...
    first_interview_user = models.ForeignKey(User, related_name="first_interviewer_user", blank=True, null=True,
    ...
    second_learning_ability = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True,
                                                  verbose_name="学习能力得分")
    second_professional_competency = models.DecimalField(decimal_places=1, null=True, blank=True, max_digits=2,
                                                         verbose_name="专业能力得分")
    second_pursue_of_excellence = models.DecimalField(decimal_places=1, null=True, blank=True, max_digits=2,
                                                      verbose_name="追求卓越得分")
    second_communication_ability = models.DecimalField(decimal_places=1, null=True, blank=True, max_digits=2,
                                                       verbose_name="沟通能力得分")
    ...
    second_result = models.CharField(max_length=256, choices=FIRST_INTERVIEW_RESULT_TYPE, blank=True,
                                     verbose_name="专业复试结果")
    second_recommend_position = models.CharField(max_length=256, blank=True, verbose_name="推荐部门")
    second_interview_user = models.ForeignKey(User, related_name="second_interviewer_user", blank=True, null=True,
                                              on_delete=models.CASCADE, verbose_name="二面面试官")
    second_remark = models.CharField(max_length=135, blank=True, verbose_name="专业复试备注")

    # HR 终面
    hr_score = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True, verbose_name="HR终面综合成绩")
