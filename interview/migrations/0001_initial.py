    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=135, verbose_name='邮箱地址')),
                ...
                ('first_score', models.DecimalField(blank=True, decimal_places=1, help_text='1-5分,极优秀:>=4.5,优秀:4-4.4,良好:3.5-3.93.5-3.9,一般: 3-3.4,较差: <3分', max_digits=2, null=True, verbose_name='初试分数')),
                ...
                ('hr_score', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR终面综合成绩')),
                ...
                ('first_interview_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='first_interviewer_user', to=settings.AUTH_USER_MODEL, verbose_name='面试官')),
                ...
                ('second_interview_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='second_interviewer_user', to=settings.AUTH_USER_MODEL, verbose_name='二面面试官')),
            ],
            options={
                'verbose_name': '应聘者',
